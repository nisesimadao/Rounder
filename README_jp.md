...
角が直線的な外部モニターや、Notch導入以前のMacで特に効果を発揮します。通常はメニューバーから静かに動作し、**アクセシビリティ・画面収録・自動化・ネットワーク権限は不要**です。
...
- **メニューバーアイコンを非表示** — 設定後はアイコンを隠してもRounderはそのまま動作
- **メニューバー中心** — 通常のバックグラウンド動作中はDockアイコンを表示しません
...
**メニューバーにアイコンがない**  
**メニューバーアイコンを表示**がオフなら正常な動作です。`Rounder.app` を開いて設定画面を表示し、必要ならそこからアイコンを再表示できます。オンにしている場合は、Rounderが起動しているか確認してください。
