...
macOSの画面の角を、自然な角丸にするネイティブユーティリティです。
...
ログイン時に起動するかを選び、**Rounderを開始**を押すとバックグラウンドで動作を開始します。メニューバーアイコンは、あとから設定で表示 / 非表示を切り替えられます。
...
**メニューバーアイコンを再表示したい**  
`Rounder.app` を開いて設定画面を表示し、**メニューバーアイコンを表示**をオンにしてください。アイコンを非表示にしていてもRounder自体は動作し続けます。
